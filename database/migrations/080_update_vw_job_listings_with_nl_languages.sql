-- Migration 080: Update vw_job_listings with Dutch language names
-- Date: 2025-12-05
-- Description: Add must_have_talen_nl and nice_to_have_talen_nl to view
...
SELECT 
    ...
    -- Spoken languages in French (NEW)
...
Includes multilingual spoken language names (must_have_talen_nl, nice_to_have_talen_nl, etc.)
Updated: 2025-12-05 to add Dutch and French language name translations';
