-- Migration 088: Add hiring_model to vw_job_listings
-- Date: 2025-12-31
-- Description: Add hiring_model (canonical) column from company_master_data and show_in_app
...
Includes company_id for linking to company_master_data table.
Includes multilingual spoken language names and time_ago columns in NL/FR/EN.
Includes hiring_model (canonical: recruitment, direct, unknown) and show_in_app filter.
time_ago logic:
...
Updated: 2025-12-31 to add hiring_model and show_in_app';
