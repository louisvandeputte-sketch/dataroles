-- Migration 084: Add company_id to vw_job_listings
-- Date: 2025-12-17
-- Description: Add company_id column to enable linking to company_master_data table
...
SELECT 
    ...
    -- Company fields
    c.id AS company_id,  -- NEW: Company ID for linking to company_master_data
    c.logo_url,
...
Updated: 2025-12-17 to add company_id column';
