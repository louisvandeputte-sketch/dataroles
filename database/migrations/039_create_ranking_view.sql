-- Create a view that combines all data needed for ranking
...
-- Add comment
COMMENT ON VIEW job_ranking_view IS 'Denormalized view for job ranking with all necessary joins pre-computed. All column names verified against database schema.';
