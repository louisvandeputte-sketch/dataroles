...
-- Date: 2025-11-30
-- Description: Fix LEAST() returning NULL when one value is NULL. Use COALESCE to handle NULL values.
...
SELECT 
    ...
    -- Corrected posted date (minimum of first_seen_at and posted_date, handling NULLs)
    -- COALESCE ensures we use whichever value is available
    LEAST(
