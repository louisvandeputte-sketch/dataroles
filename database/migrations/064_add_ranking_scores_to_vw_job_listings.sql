-- Migration 064: Add ranking scores to vw_job_listings
-- Date: 2025-11-21
-- Description: Add base_score, ranking_score, hourly_multiplier to view for frontend display
...
COMMENT ON VIEW vw_job_listings IS 'View of enriched job listings with location override support and ranking scores. Includes base_score (stable, nightly), ranking_score (hourly with multiplier), and hourly_multiplier for frontend display.';
